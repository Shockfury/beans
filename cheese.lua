...
function interface:create(title)
	...
	function objectInputed:createSlider(title, minvalue, maxvalue, callback)
		...
		addSlider.SliderButton.MouseButton1Down:Connect(function()
			...
			addSlider.SliderFrame:TweenSize(UDim2.new(0, math.clamp(mouse.X - addSlider.SliderFrame.AbsolutePosition.X, 0, 252), 0, 16), Enum.EasingDirection.InOut, Enum.EasingStyle.Linear, 0.09, false)
